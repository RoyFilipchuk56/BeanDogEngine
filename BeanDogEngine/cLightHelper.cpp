											 ...
											 unsigned int maxIterations /*= DEFAULTMAXITERATIONS = 50*/ )
{
	...
	if ( this->calcDiffuseFromAttenByDistance( cLightHelper::DEFAULTINFINITEDISTANCE, constAttenuation, linearAttenuation, quadraticAttenuation, accuracy ) > targetLightLevelHigh )
